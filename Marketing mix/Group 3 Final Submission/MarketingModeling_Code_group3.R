### sorry for the dirty code, we had complications computing the duetos and ended up hard coding the values one by one
...
dueto2 <- fread('duetos_prod2.csv')
dueto3 <- fread('duetos_prod3.csv')
...
dueto_test <- data.frame(tran_wk = prod_3_final$tran_wk,avg_shelf_price = (prod_3_final$yhat - prod_3_final$yhat_avg_shelf_price))
...
dueto2 <- merge(dueto2, prod_2_final[,c(1,5)], by = 'tran_wk')
dueto2 <- merge(dueto2, prod_2_final[,c(1,60)], by = 'tran_wk')
dueto3 <- merge(dueto3, prod_3_final[,c(1,5)], by = 'tran_wk')
dueto3 <- merge(dueto3, prod_3_final[,c(1,60)], by = 'tran_wk')
